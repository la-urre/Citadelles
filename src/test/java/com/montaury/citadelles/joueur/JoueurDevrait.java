...
import static com.montaury.citadelles.joueur.JoueursPredefinis.unJoueurAvec;
import static com.montaury.citadelles.joueur.TrésorPrédéfini.trésorDe;
...
public class JoueurDevrait {
    ...
    public void pouvoir_batir_un_quartier_s_il_a_assez_de_pieces() {
        Joueur joueur = unJoueurAvec(trésorDe(7));
    ...
    public void ne_pas_pouvoir_batir_un_quartier_s_il_n_a_pas_assez_de_pieces() {
        Joueur joueur = unJoueurAvec(trésorDe(4));
        joueur.ajouterCarteALaMain(Carte.PALAIS_1);
    ...
    public void batir_un_quartier_avec_une_carte_de_sa_main() {
        Joueur joueur = unJoueurAvec(trésorDe(2));
        ...
        assertThat(joueur.cité().quartiers()).containsExactly(Quartier.EGLISE);
    }
    ...
    public void echanger_la_main_avec_un_autre_joueur() {
        ...
        assertThat(joueur.main().cartes()).containsExactlyInAnyOrder(Carte.CASERNE_1, Carte.CIMETIERE);
        assertThat(joueur2.main().cartes()).containsExactly(Carte.CHATEAU_1);
    }

    @Test
    public void recuperer_les_pieces_d_un_autre_joueur_en_le_volant() {
        Joueur joueur = unJoueurAvec(trésorDe(2));
        Joueur joueur2 = unJoueurAvec(trésorDe(10));
